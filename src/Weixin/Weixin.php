...
class Weixin extends AbstractAPI
{
    ...
    const ACTIVE_LUCKY_DRAW = 'weixin/luckydraw'; // 抽奖
    const ACTIVE_LUCKY_PRODUCT = 'weixin/getLuckyProductList'; // 中奖结果
    ...
    {
        return $this->parseJSON(static::POST, [self::ACTIVE_LUCKY_DRAW, $params]);
    }

    public function luckyProduct($params = [])
    {
        return $this->parseJSON(static::POST, [self::ACTIVE_LUCKY_PRODUCT, $params]);
    }
}
